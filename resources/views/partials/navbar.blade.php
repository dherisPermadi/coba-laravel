<nav class="navbar navbar-expand-lg navbar-dark bg-success">
  <div class="container">
    <a class="navbar-brand" href="#">Dheris - Blog</a>
      ...
      <ul class='navbar-nav ms-auto'>
        @auth
          <li clas="nav-item dropdown">
            <a href="#" class="nav-ilnk dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
